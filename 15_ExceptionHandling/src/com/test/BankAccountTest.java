...
public class BankAccountTest {
	...
	private static BankAccount processChoice(int choice, Scanner scanner, BankAccount account,Random random) {
	...
	private static BankAccount createAccount(Scanner scanner, Random random) {
	...
	private static void debitFromAccount(Scanner scanner, BankAccount account) {
		System.out.println("Enter the amount to debit: ");
		try {
		double amount = scanner.nextDouble();
		account.debit(amount);
		}
		catch(MinimumBalanceException | OverdraftLimitExceededException  exception) {
			System.out.println(exception.getMessage());
		}
		
	}
	private static void creditToAccount(Scanner scanner, BankAccount account) {
